...
import './../../scss/components/_thumbnail';
...
class Thumbnail extends React.Component {
  ...
  render() {
    ...
    if (spacePosition === -1) {
      ...
      resultChar = `${this.props.text.charAt(0)}${this.props.text.charAt(spacePosition + 1)}`;
    }

    return (
      <div className="thumbnail thumbnail--has-char">
        <span className="thumbnail__char">{resultChar.toUpperCase()}</span>
      </div>
    );
  }
}
