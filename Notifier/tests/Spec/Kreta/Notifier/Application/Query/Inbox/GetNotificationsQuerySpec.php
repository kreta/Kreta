...
namespace Spec\Kreta\Notifier\Application\Query\Inbox;

use Kreta\Notifier\Application\Query\Inbox\GetNotificationsQuery;
use PhpSpec\ObjectBehavior;

class GetNotificationsQuerySpec extends ObjectBehavior
{
    function it_can_be_created()
    {
        $this->beConstructedWith('user-id', 0, 10);
        $this->shouldHaveType(GetNotificationsQuery::class);
