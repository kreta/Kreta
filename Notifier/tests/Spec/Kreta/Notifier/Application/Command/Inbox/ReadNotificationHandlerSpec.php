...
class ReadNotificationHandlerSpec extends ObjectBehavior
{
    private $notificationId;
    private $userId;

    function let(UserRepository $repository, ReadNotificationCommand $command)
    {
    ...
    function it_reads_notification(
        ...
        $user->readNotification($notification)->shouldBeCalled();
