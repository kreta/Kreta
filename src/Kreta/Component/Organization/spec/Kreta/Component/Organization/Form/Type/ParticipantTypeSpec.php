...
/**
 * Spec file of ParticipantType class.
 *
...
class ParticipantTypeSpec extends ObjectBehavior
{
    function let(
        ...
        $this->beConstructedWith('Kreta\Component\Organization\Model\Participant', $factory, $context);
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('Kreta\Component\Organization\Form\Type\ParticipantType');
    }
    ...
    {
        $builder->add('role', 'Kreta\Component\Organization\Form\Type\RoleType')->shouldBeCalled()->willReturn($builder);
    ...
    {
        $resolver->setDefaults(Argument::withEntry('data_class', 'Kreta\Component\Organization\Model\Participant'))
        ...
        $resolver->setDefaults(Argument::withEntry('empty_data', Argument::type('closure')))
            ->shouldBeCalled()->willReturn($resolver);
        $resolver->setRequired(['organization'])->shouldBeCalled()->willReturn($resolver);
