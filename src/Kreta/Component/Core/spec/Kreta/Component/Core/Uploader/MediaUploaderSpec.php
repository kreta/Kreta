...
namespace spec\Kreta\Component\Core\Uploader;
 ...
 *
 * @package spec\Kreta\Component\Core\Uploader
 */
class MediaUploaderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Kreta\Component\Core\Uploader\MediaUploader');
    }

    function it_implements_media_uploader_interface()
    {
        $this->shouldImplement('Kreta\Component\Core\Uploader\Interfaces\MediaUploaderInterface');
    }
