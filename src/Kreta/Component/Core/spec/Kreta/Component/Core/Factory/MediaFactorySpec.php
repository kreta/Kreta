...
class MediaFactorySpec extends ObjectBehavior
{
    function let(UploadedFile $file)
    {
        ...
        $this->beConstructedWith('Kreta\Component\Core\Model\Media');
    }

    function it_is_initializable()
    {
        $this->shouldHaveType('Kreta\Component\Core\Factory\MediaFactory');
    }

    function it_creates_a_media(UploadedFile $file)
    {
        $this->create($file)->shouldReturnAnInstanceOf('Kreta\Component\Core\Model\Media');
    }
}
