...
namespace spec\Kreta\Bundle\ApiBundle\EventSubscriber;
 ...
 *
 * @package spec\Kreta\Bundle\ApiBundle\EventSubscriber
 */
class MediaUrlSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Kreta\Bundle\ApiBundle\EventSubscriber\MediaUrlSubscriber');
    }
