...
class WorkflowHandlerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Kreta\Bundle\ApiBundle\Form\Handler\WorkflowHandler');
    }
    ...
    {
        $formFactory->create(Argument::type('\Kreta\Bundle\ApiBundle\Form\Type\WorkflowType'), $workflow, [])
