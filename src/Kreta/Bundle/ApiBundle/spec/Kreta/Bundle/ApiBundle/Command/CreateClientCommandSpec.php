...
namespace spec\Kreta\Bundle\ApiBundle\Command;
 ...
 *
 * @package spec\Kreta\Bundle\ApiBundle\Command
 */
class CreateClientCommandSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Kreta\Bundle\ApiBundle\Command\CreateClientCommand');
    }
