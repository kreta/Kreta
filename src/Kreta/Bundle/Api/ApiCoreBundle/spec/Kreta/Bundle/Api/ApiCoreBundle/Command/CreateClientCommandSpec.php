...
namespace spec\Kreta\Bundle\Api\ApiCoreBundle\Command;
 ...
 *
 * @package spec\Kreta\Bundle\Api\ApiCoreBundle\Command
 */
class CreateClientCommandSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Kreta\Bundle\Api\ApiCoreBundle\Command\CreateClientCommand');
    }
