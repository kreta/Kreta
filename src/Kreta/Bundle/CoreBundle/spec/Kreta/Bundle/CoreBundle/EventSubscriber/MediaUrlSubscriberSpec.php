...
namespace spec\Kreta\Bundle\CoreBundle\EventSubscriber;
 ...
 *
 * @package spec\Kreta\Bundle\CoreBundle\EventSubscriber
 */
class MediaUrlSubscriberSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Kreta\Bundle\CoreBundle\EventSubscriber\MediaUrlSubscriber');
    }
