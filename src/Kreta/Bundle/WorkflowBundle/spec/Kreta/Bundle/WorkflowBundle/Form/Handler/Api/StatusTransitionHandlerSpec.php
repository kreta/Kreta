...
class StatusTransitionHandlerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Kreta\Bundle\WorkflowBundle\Form\Handler\Api\StatusTransitionHandler');
    }
    ...
    {
        $formFactory->create(
            Argument::type('\Kreta\Bundle\WorkflowBundle\Form\Type\Api\StatusTransitionType'),
            $statusTransition,
            []
